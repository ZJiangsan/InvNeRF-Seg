...
for folder_i in folder_ls:
    ...
    # checkpoint_path = "best_checkpoint_nerfacto{}FruitNeRF_April2026_defaultConfig_001_BCEMaskLoss.pth".format(folder_i)
    ...
    for epoch in range(12000):
        ...
        if loss_out_final_i_0 < best_loss_i:
            ...
            save_checkpoint_multiple(nerfmodel, optimizers, 
                                     epoch, "best_checkpoint_nerfacto{}FruitNeRF_April2026_defaultConfig_001_BCEMaskLoss.pth".format(folder_i))
    ...
    import pickle
    with open("iou_log_fruitNerf_{}_BCELossOnly.pkl".format(folder_i), "wb") as f:
    ...
    plt.savefig('{}_ablation_fruitNeRF_BCELossOnly.png'.format(folder_i), dpi=300, bbox_inches='tight')
    plt.savefig('{}_ablation_fruitNeRF_BCELossOnly.pdf'.format(folder_i), dpi=300, bbox_inches='tight')
    plt.close()
