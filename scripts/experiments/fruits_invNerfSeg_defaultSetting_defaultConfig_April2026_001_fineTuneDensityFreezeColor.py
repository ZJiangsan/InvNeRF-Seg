        ...
        for epoch in range(6000):
            ...
            if loss_out_final_i_0 < best_loss_i:
                ...
                save_checkpoint_multiple(nerfmodel, optimizers, 
                                         epoch, "best_checkpoint_invNerf_fruitsN{}_RGB_defaultConfig_001_April2026_fineTuneDensityFreezeColor.pth".format(folder_i))
...
import pickle
with open("iou_log_invNerf_{}_fineTuneDensityFreezeColor.pkl".format(folder_i), "wb") as f:
...
plt.savefig('{}_ablation_fineTuneDensityFreezeColor.png'.format(folder_i), dpi=300, bbox_inches='tight')
plt.savefig('{}_ablation_fineTuneDensityFreezeColor.pdf'.format(folder_i), dpi=300, bbox_inches='tight')
plt.close()
