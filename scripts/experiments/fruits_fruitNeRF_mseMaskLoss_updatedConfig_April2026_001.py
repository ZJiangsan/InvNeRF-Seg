...
# checkpoint_path = "best_checkpoint_nerfactoAppleFruitNeRF_April2026_defaultConfig_002_mseMaskLoss.pth"
...
for epoch in range(10000):
    ...
    if loss_out_final_i_0 < best_loss_i:
        ...
        save_checkpoint_multiple(nerfmodel, optimizers, 
                                 epoch, "best_checkpoint_nerfactoAppleFruitNeRF_April2026_defaultConfig_002_mseMaskLoss.pth")
...
import pickle
with open("iou_log_fruitNerf_{}_002_mseLossOnly.pkl".format(folder_i), "wb") as f:
...
plt.savefig('apple_ablation_fruitNeRF_002_mseLossOnly.png', dpi=300, bbox_inches='tight')
plt.savefig('apple_ablation_fruitNeRF_002_mseLossOnly.pdf', dpi=300, bbox_inches='tight')
plt.close()
