...
# folder_ls = ["soybeanRGB", "peachRGB_out"]
folder_ls = ["soybeanRGB"]
...
for tr_stg in [2]:
    ...
    for f_i in range(len(folder_ls)):
        ...
        if tr_stg != 1:
            ...
            checkpoint_path = "checkpoint_invNerf_soybean{}_defaultConfig_001_2026.pth".format(folder_i_0)
        ...
        for epoch in range(3000):
            ...
            if loss_out_final_i_0 < best_loss_i:
                ...
                save_checkpoint_multiple(nerfmodel, optimizers, 
                                         epoch, "checkpoint_invNerf_soybean{}_defaultConfig_001_2026.pth".format(folder_i))
