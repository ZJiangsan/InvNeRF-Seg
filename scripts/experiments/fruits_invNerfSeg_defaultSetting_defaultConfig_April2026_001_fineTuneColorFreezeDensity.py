        ...
        for epoch in range(6000):
            ...
            if loss_out_final_i_0 < best_loss_i:
                ...
                save_checkpoint_multiple(nerfmodel, optimizers, 
                                         epoch, "best_checkpoint_invNerf_fruitsN{}_RGB_defaultConfig_001_April2026_fineTuneColorFreezeDensity.pth".format(folder_i))
...
import pickle
with open("iou_log_invNerf_{}_fineTuneColorFreezeDensity.pkl".format(folder_i), "wb") as f:
...
plt.savefig('{}_invNerf_ablation_fineTuneColorFreezeDensity.png'.format(folder_i), dpi=300, bbox_inches='tight')
plt.savefig('{}_invNerf_ablation_fineTuneColorFreezeDensity.pdf'.format(folder_i), dpi=300, bbox_inches='tight')
plt.close()
