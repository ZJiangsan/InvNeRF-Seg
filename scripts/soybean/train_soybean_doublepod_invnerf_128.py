# -*- coding: utf-8 -*-
"""
Created on Fri Apr  4 16:22:55 2025
...
file_path = 'D:/InvNerf_seg_relatedScripts/soybeanRelated/soybeanSeg_doublePodMASK/transforms.json'  # Update with the path to your file
...
for image_name in img_ls_out:
    img_path = os.path.join("D:/InvNerf_seg_relatedScripts/soybeanRelated/soybeanSeg_doublePodMASK/images", image_name)
...
data_config.data = Path('D:/InvNerf_seg_relatedScripts/soybeanRelated/soybeanSeg_doublePodMASK')
...
dataManager_config.dataparser.data = Path("D:/InvNerf_seg_relatedScripts/soybeanRelated/soybeanSeg_doublePodMASK")
...
for epoch in range(6000):
    ...
    if loss_out_final_i_0 < best_loss_i:
        ...
        save_checkpoint_multiple(nerfmodel, optimizers, 
                                 epoch, "soybean_doublepod_invnerf_128.pth")
